...
>
  <img src="src/images/shape/grid-01.svg" alt="grid" />
        ...
        <div class="fixed z-50 bottom-6 right-6 ">
          <button
            class="inline-flex items-center justify-center text-white transition-colors rounded-full w-20 h-20 bg-blue-500 hover:bg-blue-600"
            @click.prevent="darkMode = !darkMode"
          >
            <svg
              class="hidden w-10 h-10 fill-current dark:block"
              viewBox="0 0 20 20"
              fill="none"
            ...
            <svg
              class="fill-current w-10 h-10 dark:hidden"
              viewBox="0 0 20 20"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
