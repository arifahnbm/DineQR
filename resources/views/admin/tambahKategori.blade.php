...
<head>
    ...
    <title>Admin Seblang | Tambah Kategori</title>
...
<main class="pt-16 transition-all duration-300 p-4
    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <div class="flex items-center space-x-1.5">
            <svg class="w-3.5 h-3.5 rtl:rotate-180 text-body" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 5 7 7-7 7"/></svg>
            <span class="inline-flex items-center text-sm font-medium text-body-subtle">Tambah Kategori</span>
        </div>
        </li>
    </ol>
    </nav>
    ...
    <form id="myForm" action="{{ route('admin.store.kategori') }}" method="POST" enctype="multipart/form-data"
        ...
        @csrf
        <h2 class="text-2xl font-bold text-center mb-6 dark:text-white">Tambah Kategori</h2>

        <div class="mb-4">
            <label for="nama" class="block text-gray-700 text-sm font-bold mb-2 dark:text-white">Nama Kategori</label>
